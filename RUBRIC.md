...
| **U4.5** | Where no energy figure is published, **energy is derived from the macronutrients** using the Codex factors: carbohydrate 4 kcal/g, protein 4 kcal/g, fat 9 kcal/g. Where the macronutrients are also missing, the protein half is **UNKNOWN** | **SOURCED** — S6 §3.3.1, verbatim · tier 1 |
